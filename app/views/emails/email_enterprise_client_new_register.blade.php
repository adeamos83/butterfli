...
<head>
    ...
    <title>New {{ $mail_body['provider'] }} Created</title>
                    ...
                    <tr>
                        <td class="resp-full-td" valign="top" style="padding:20px; text-align:center;">
                            ...
                            helvetica, arial, sans-serif; font-weight:100; color:#ffffff">
                                <a  style="color:#ffffff; outline:none; text-decoration:none;">
                                    New {{ $mail_body['provider'] }} Request Created. </a> </span>
                        </td>
                    </tr>
                </table>
            </td>
                            ...
                            <table width="100%" align="right" class="resp-full-table" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td width="100%" class="resp-full-td" valign="top" style="text-align : justify;">
                                        ...
                                        color:#0e70a5;text-align:center;">Please review and approve the request. Details are as follows:
                                            <br>
                                            <div style="padding: 10px;font-size:18px; font-family:'Helvetica Neue', helvetica,
                                            arial, sans-serif; font-weight:100; color:#545454;text-align:left;">Company Name: {{ $mail_body['username'] }}
                                            </div>
                                            <div style="padding: 10px;font-size:18px; font-family:'Helvetica Neue', helvetica, arial, sans-serif;
                                        font-weight:100; color:#545454;text-align:left;">Company Email: {{ $mail_body['email'] }}
                                            </div>
                                            <div style="padding: 10px;font-size:18px; font-family:'Helvetica Neue', helvetica, arial,
                                            sans-serif; font-weight:100; color:#545454;text-align:left;">Company: {{ $mail_body['company'] }}
                                            </div>

                                        <br><br>

                                        <div style="text-align:center"><a href="{{ $mail_body['follow_url'] }}" style="padding: 10px;font-size:18px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100;background-color: #800080;color:#fff;text-align:center;  text-decoration: none;">Approve or Decline </a></div>
                                        <br>
                                    </td>
                                </tr>
                            </table>
