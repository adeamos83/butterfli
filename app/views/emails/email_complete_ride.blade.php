...
<head>
    ...
    <title>Ride Request Completed</title>
    <style type="text/css">
                ...
                <table width="660" class="resp-full-table" align="center" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td class="resp-full-td" valign="top" style="padding:0; text-align:center;">
                            <p style="font-family:'Helvetica Neue', helvetica, arial, sans-serif;text-align:right;line-height:0;color:#2889bb;padding-right:135px;">Completed</p>
                            <span style="font-size:25px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#ffffff"><a href="{{ web_url() }}" style="color:#ffffff; outline:none; text-decoration:none;"><img src="https://s3-us-west-2.amazonaws.com/butterfli-bucket/email_icons/completed-bar.png" width="330"></a></span>
                        </td>
                    </tr>
                    <tr>
                        <td class="resp-full-td" valign="top" style="text-align:center;">
                            <p style="font-family:'Helvetica Neue', helvetica, arial, sans-serif;font-size:18px; line-height:0;color:black;">Thanks for Riding with ButterFli</p>
                            <br>
                        </td>
                    </tr>
                    <tr>
        ...
        <tr>
            <td style="background-color:#FFFFff ">
                <table width="660" class="resp-full-table" align="center" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                    <tr>
                        <td class="resp-full-td" valign="top" style="padding:10px 20px; width:50%;color:black;">
                            Driver:  <strong>{{ $mail_body['driver_name'] }}</strong>
                        </td>
                        <td class="resp-full-td" valign="top" style="padding:10px 81px;text-align:right;width:50%;">
                            <img src="https://s3-us-west-2.amazonaws.com/butterfli-bucket/email_icons/phone-icon.png" width="18"> <span style="float:right;padding-left:3px;color:black;"><strong> {{ $mail_body['driver_phone'] }}</strong></span>
                        </td>
                    </tr>
                    <tr>
                        <td class="resp-full-td" valign="top" style="padding:0 20px; width:50%;color:black;">
                    ...
                    <tr>
                        <td class="resp-full-td" valign="top" style="padding-left:20px;">
                            ...
                            <br>
                            <img src="https://s3-us-west-2.amazonaws.com/butterfli-bucket/email_icons/circle_pink.png" width="9"><span style="color:black;padding-left:3px;position:relative;">Dropoff</span>
