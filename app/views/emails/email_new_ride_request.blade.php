...
<head>
    ...
    <title>Ride Request Created</title>
    <style type="text/css">
                ...
                <table width="660" class="resp-full-table" align="center" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td class="resp-full-td" valign="top" style="text-align:center;">
                            ...
                            <p style="font-size:20px; line-height:2;color:black;font-weight: bold;">You've got a ride request!</p>
                            <br>
                        </td>
                    </tr>
                    <tr>
                ...
                <table width="660" class="resp-full-table" align="center" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td class="resp-full-td" valign="top" style="padding-left:20px;">
                            <p>When: <strong>{{ $mail_body['pickup_date'] }} at {{ $mail_body['pickup_time'] }}</strong></p>
                            <br>
                        </td>
                    </tr>
                    <tr>
