                ...
                <table width="660" class="resp-full-table" align="center" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td class="resp-full-td" valign="top" style="padding:0 20px; width:50%;">
                            <p style="color:#000000;">Passenger: <strong>{{ $mail_body['passenger_name'] }}</strong></p>
                            <p style="color:#000000;">Wheelchair Requested: <strong><?php echo ($mail_body['has_wheelchair'] == 1) ? "YES" : "NO"; ?></strong></p>
                            <br>
                        </td>
                    ...
                    <tr>
                        <td class="resp-full-td" valign="top" style="padding-left:20px;">
                            <p>Ride Status: <strong>{{ $mail_body['ride_status'] }}</strong></p>
                            <br>
                        </td>
                    </tr>
                    <tr>
