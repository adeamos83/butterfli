                ...
                <table width="660" class="resp-full-table" align="center" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td class="resp-full-td" valign="top" style="text-align:center;">
                            <br>
                            <p style="font-family:'Helvetica Neue', helvetica, arial, sans-serif;font-size:20px; line-height:0;color:black;"><strong>We're Sorry</strong></p>
                            <p style="font-family:'Helvetica Neue', helvetica, arial, sans-serif;color:black;line-height:35px;">Your request can't be fullfiled at this time</p>
                        </td>
                    </tr>
                    <tr>
                        <td class="resp-full-td" valign="top" style="padding:0 20px; text-align:center;">
                            <p style="font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100;color:black;"> We have recieved your request but unfortunately due to an unusually high volume of ride request at this time. we cannot fulfil your ride</p>
                            <br>
                ...
                <table width="660" class="resp-full-table" align="center" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td class="resp-full-td" valign="top" style="padding:0 20px; width:50%;color:black;">
                            UID: <strong>{{ $mail_body['trip_id'] }}</strong><br>
                            Passenger: <strong>{{ $mail_body['passenger_name'] }}</strong>
                        </td>
                        <td class="resp-full-td" valign="top" style="padding:10px 73px;text-align:right;width:50%;">
                            <img src="https://s3-us-west-2.amazonaws.com/butterfli-bucket/email_icons/phone-icon.png" width="18"> <span style="float:right;padding-left:3px;color:black;"><strong>{{ $mail_body['passenger_phone'] }}</strong></span>
                        </td>
                    </tr>
                    <tr>
                        <td class="resp-full-td" valign="top" style="padding:10px 20px;color:black;">
                    ...
                    <tr>
                        <td class="resp-full-td" valign="top" style="padding-left:20px";>
                            <img src="https://s3-us-west-2.amazonaws.com/butterfli-bucket/email_icons/circle.png" width="9"><span style="padding-left:3px;position:relative;color:black;">Pickup {{ $mail_body['pickup_time'] }}</span>
                            <strong style="display:block;padding-left:14px;color:black;">{{ $mail_body['pickup_location'] }}</strong>
                            <br>
                            <img src="https://s3-us-west-2.amazonaws.com/butterfli-bucket/email_icons/circle_pink.png" width="9"><span style="padding-left:3px;position:relative;color:black;">DropOff</span>
                            <strong style="display:block;padding-left:14px;color:black;">{{ $mail_body['dropoff_location'] }}</strong>
                        </td>
                    </tr>
            ...
            <td style="background-color:#FFFFff ">
                <table width="660" class="resp-full-table" align="center" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td class="resp-full-td" valign="top" style="padding:0 73px; text-align:right;width:50%;">
                            <img src="https://s3-us-west-2.amazonaws.com/butterfli-bucket/email_icons/phone-icon.png" width="18"><span style="float:right;color:black;padding-left:3px;"><strong>{{ $mail_body['butterfli_dispatcher_phno'] }}</strong></span>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td style="background-color:#FFFFff; ">
                <table width="660" class="resp-full-table" align="center" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td class="resp-full-td" valign="top" style=" text-align:center;">
                            <a href="{{ $mail_body['follow_url'] }}" style="color:#7f0f7e;"><strong>See more information related to your rides</strong></a>
                        </td>
                    </tr>
                    <tr style="width:100%;">
                        <td class="resp-full-td" valign="top" style=" text-align:center;width:100%;">
                            <p style="color:black;">For any questions {{ $mail_body['admin_email'] }}</p>
                        </td>
                    </tr>
                </table>
            </td>
