                ...
                <table width="660" class="resp-full-table" align="center" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td class="resp-full-td" valign="top" style="padding:0; text-align:center;">
                            <p style="text-align:center;line-height:0;color:#2889bb;">Canceled</p>
                            <span style="font-size:25px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:400; color:#ffffff"><a href="{{ web_url() }}" style="color:#ffffff; outline:none; text-decoration:none;"><img src="https://s3-us-west-2.amazonaws.com/butterfli-bucket/email_icons/cancelled-bar.png" width="330"></a></span>
                        </td>
                    </tr>
                    <tr>
                        <td class="resp-full-td" valign="top" style="text-align:center;">
                            <p style="font-size:20px; line-height:0;color:black;font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100;">You've Canceled your ride request</p>
                            <br>
                            <p style="font-size:15px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100;color:black;line-height:35px;">because</p>
                            <p style="color:black;">{{ $mail_body['cancel_reason'] }}</p>
                        </td>
                    </tr>
                    <tr>
    ...
    <table id="email-penrose-conteneur" width="660" align="center" style="border-right:1px solid #e2e8ea; border-left:1px solid #e2e8ea; background-color:#ffffff;" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            <td style="background-color:#FFFFff ">
                <table width="660" class="resp-full-table" align="center" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td class="resp-full-td" valign="top" style="padding:10px 20px; width:50%;">
                    ...
                    <tr>
                        <td class="resp-full-td" valign="top" style="padding:0 20px;">
                            <p>Cancellation Fee: <strong>{{ $mail_body['cancellation_fee'] }}</strong></p>
                            <br>
                        </td>
                    </tr>
                    @if($mail_body['all_radio']!=0)
                        <tr>
                    ...
                    <tr>
                        <td class="resp-full-td" valign="top" style="padding-left:20px;">
                            ...
                            <img src="https://s3-us-west-2.amazonaws.com/butterfli-bucket/email_icons/circle.png" width="9"><span style="padding-left:3px;position:relative;">Pickup</span>
                            <strong style="color:black;padding-left:14px;display:block;">{{ $mail_body['pickup_location'] }}</strong>
                            <br><br>
                            <img src="https://s3-us-west-2.amazonaws.com/butterfli-bucket/email_icons/circle_pink.png" width="9"><span style="padding-left:3px;position:relative;">Dropoff</span>
        ...
        <tr>
            <td style="background-color:#FFFFff; ">
                <table width="660" class="resp-full-table" align="center" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td class="resp-full-td" valign="top" style=" text-align:center;">
                            <a href="{{ $mail_body['follow_url'] }}" style="color:#7f0f7e;">See more information related to your rides</a>
                        </td>
                    </tr>
                    <tr style="width:100%;">
