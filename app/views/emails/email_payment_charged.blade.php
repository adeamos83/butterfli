...
<html>
    <head>
        ...
        <title>Request Payment Charged</title>
            ...
            <table width="660" class="resp-full-table" align="center" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="resp-full-td" valign="top" style="padding:20px; text-align:center;">
                        <span style="font-size:25px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#ffffff"><a href="{{ web_url() }}" style="color:#ffffff; outline:none; text-decoration:none;">Payment Done With {{ $mail_body['req_id'] }}</a></span>
                    </td>
                </tr>
                <!-- <tr>
                            ...
                            <tr>
                                <td width="100%" class="resp-full-td" valign="top" style="text-align : justify;">
                                    ...
                                    <div style="padding: 10px;font-size:12px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#545454;text-align:left;">
                                        Hi, <strong style="font-weight: bold;">{{ $mail_body['name'] }}</strong>,
                                        <br>
                                        Your payment with <?php /* echo "App Name"; */ echo ucwords(Config::get('app.website_title')); ?> is done of <strong style="font-weight: bold;">{{ $mail_body['amount'] }}</strong> with <strong style="font-weight: bold;">{{ $mail_body['req_id'] }}</strong>. 
                                        Please do share your feedback on your experience. We are looking forward to serve you soon.
                                        <br>
                                        <br>
                                        Thanks,
                                        <br>
                                        <?php /* echo "App Name"; */ echo ucwords(Config::get('app.website_title')); ?> team.
                                    </div>
