...
<head>
    ...
    <title>Ride Request Confirmed</title>
    <style type="text/css">
                ...
                <table width="660" class="resp-full-table" align="center" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td class="resp-full-td" valign="top" style="padding:0; text-align:center;">
                            <p style="text-align:center;line-height:0;color:#2889bb;">Confirmed</p>
                            <span style="font-size:25px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#ffffff"><a href="{{ web_url() }}" style="color:#ffffff; outline:none; text-decoration:none;"><img src="https://s3-us-west-2.amazonaws.com/butterfli-bucket/email_icons/confirmed-bar.png" width="330"></a></span>
                        </td>
                    </tr>
                    <tr>
                        <td class="resp-full-td" valign="top" style="text-align:center;">
                            <p style="font-size:20px; line-height:0;color:black;">Your Ride is confirmed</p>
                            <br>
                        </td>
                    </tr>
                    <tr>
            ...
            <td style="background-color:#FFFFff ">
                <table width="660" class="resp-full-table" align="center" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td class="resp-full-td" valign="top" style="padding:10px 99px;text-align:right;width:50%;">
                    ...
                    <tr>
                        ...
                        <td class="resp-full-td" valign="top" style="padding:0 73px;text-align:right;width:50%;">
                            <img src="https://s3-us-west-2.amazonaws.com/butterfli-bucket/email_icons/phone-icon.png" width="18"> <span style="float:right;color:black;padding-left:3px;"><strong>{{ $mail_body['passenger_phone'] }}</strong></span>
                        </td>
                    </tr>
                    @if($mail_body['estimated_time']>0)
                        <tr>
                            <td class="resp-full-td" valign="top" style="padding:0 20px;color:black;">
                                <p>Driver ETA: <strong>{{ $mail_body['estimated_time'] }}</strong></p>
                                <br>
                            </td>
                        </tr>
                    @endif
                    ...
                    <tr>
                        <td class="resp-full-td" valign="top" style="padding-left:20px;">
                            <p>Track Driver: <a href="{{ $mail_body['walker_id'] }}"><u>click here</u></a></p>
                            <br>
                        </td>
                    </tr>
