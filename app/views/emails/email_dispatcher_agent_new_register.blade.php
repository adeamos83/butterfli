...
<head>
    ...
    <title>New Agent Request Created</title>
                        ...
                        <td class="resp-full-td" valign="top" style="padding:20px; text-align:center;">
                            ...
                            helvetica, arial, sans-serif; font-weight:100; color:#ffffff">
                                <a  style="color:#ffffff; outline:none; text-decoration:none;">
                                    New Agent Provider Request Created. </a> </span>
                        </td>
                    </tr>
                </table>
            </td>
                                ...
                                <tr>
                                    <td width="100%" class="resp-full-td" valign="top" style="text-align : justify;">
                                        ...
                                        color:#0e70a5;text-align:center;">Please review and approve the request. Details are as follows:
                                            ...
                                            arial, sans-serif; font-weight:100; color:#545454;text-align:left;">Agent Name: {{ $mail_body['username'] }}
                                            </div>
                                            <div style="padding: 10px;font-size:18px; font-family:'Helvetica Neue', helvetica, arial, sans-serif;
                                        font-weight:100; color:#545454;text-align:left;">Agent Email: {{ $mail_body['email'] }}
                                            </div>
