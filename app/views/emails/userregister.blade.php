				...
				<table width="660" class="resp-full-table" align="center" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td width="50%" style="text-align:left;">
							<a style="text-decoration:none;"><h3 style="font-size: 25px;font-family: 'Helvetica Neue', helvetica, arial, sans-serif;font-weight: bold;color: #6B6B6B;margin: 0;"><?php  $siteTitle = Config::get('app.website_title'); echo $siteTitle;  ?>
								</h3></a>
						</td>
				...
				<table width="660" class="resp-full-table" align="center" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td class="resp-full-td" valign="top" style="padding:20px; text-align:center;">
							<span style="font-size:25px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#ffffff"><a style="color:#ffffff; outline:none; text-decoration:none;">Welcome to <?php  $siteTitle = Config::get('app.website_title'); echo $siteTitle;  ?>
							...
							<table width="100%" align="right" class="resp-full-table" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td width="100%" class="resp-full-td" valign="top" style="text-align : justify;">
										...
										font-weight:100;color:#545454;text-align:center;">Thanks for signing up! We're excited to have you join us and start riding.
										</div>
										...
										<div style="padding: 0px 10px;font-size:12px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100;color:#545454;">Sit back and relax. We'll text you when your Uber arrives. 
										</div>
										...
										<div style="text-align:center"><a href="{{ $mail_body['follow_url'] }}" style="padding: 10px;font-size:18px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100;background-color: #2ECC71;color:#fff;text-align:center;  text-decoration: none;">Go to Site </a></div>
										<br>
									</td>
								</tr>
