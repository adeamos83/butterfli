                ...
                <div class="page-sidebar navbar-collapse collapse" >
                    ...
                    <ul class="page-sidebar-menu page-sidebar-menu-light" data-keep-expanded="true" data-auto-scroll="true" data-slide-speed="200">
                        ...
                        <li id="walks"><span class="arrow "></span>
                            ...
                            <a href=" {{ URL::Route('AdminpartnerRequest')}}">
                        ...
                        <li id="payment"><span class="arrow "></span>
                            ...
                            <a href=" {{ URL::Route('AdminpartnerRequest_payment')}}">
                        ...
                        <li id="invoice"><span class="arrow "></span>
                            ...
                            <a href=" {{ URL::Route('AdminpartnerRequest_payment_invoice')}}">
                ...
                <!--                <div class="page-sidebar navbar-collapse collapse" >
                                    ...
                                    <ul class="sidebar-menu">
                                        ...
                                        <li id="walks" title="Request">
                                            <a href="{{ URL::Route('AdminpartnerRequest') }}"><i class="fa fa-location-arrow"></i> <span>Trips</span></a>
                                        </li>
                                        ...
                                        <li id="car_detail" title="Payment">
                                            <a href="{{ URL::Route('AdminpartnerRequest_payment') }}"><i class="fa fa-calculator"></i> <span>Payment Statement On Trip</span></a>
                                        </li>
                                    </ul>
