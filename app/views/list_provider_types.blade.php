    ...
    <table class="table table-bordered">
        <tbody>
            <tr>
                ...
                <th>Base Price (in US Dollar)</th>
                <th>Price Per Unit Distance (in US Dollar)</th>
                <th>Price Per Unit Time (in US Dollar)</th>
                <th>Maximum space</th>
                <th>Visibility</th>
                <th>Actions</th>
            </tr>
            <?php foreach ($types as $type) {
                ?>
                <tr>
                    <td><a href="{{ URL::Route('AdminProviderTypeEdit', $type->id) }}"><?= $type->id ?></a></td>
                    <td><?= $type->name ?>
...
<?php if ($success == 4) { ?>
    <script type="text/javascript">
        alert('Type image must be square and size in pixel must be more then 300px');
    </script>
<?php } ?>
