    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 login-area">
                ...
                <form class="form-login" action="{{route('ConsumerVerify')}}" method="post">
                    ...
                    <ul>
                        ...
                        <li class="half">
                            <a href="{{route('ConsumerSignup')}}">Create an account</a>
                        </li>
                        <li>
                ...
                <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModal" class="modal fade">
                    <div class="modal-dialog" style="width: 415px;">
                        <div class="modal-content">
                            ...
                            <form method="POST" action="{{route('ConsumerForgotPassword')}}">
