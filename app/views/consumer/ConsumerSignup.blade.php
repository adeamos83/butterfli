        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 login-area">
                    <form class="form-login" enctype="multipart/form-data" onsubmit="Checkfiles(this)" action="{{URL::Route('ConsumerSave')}}" method="post">
                        ...
                        <ul>
                            ...
                            <li><input type="text" name="phone" required class="form-control" placeholder="Phone" ></li>
                            <li>
                            ...
                            <li class="registration half">
                                ...
                                <a class="" href="{{route('ConsumerSignin')}}">
                                    Sign in
                                </a>
                            </li>
