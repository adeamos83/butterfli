                ...
                <div class="col-md-4 col-sm-4 col-lg-4">
                    ...
                    <select name="owner_id" style="overflow:hidden;" class="form-control">
                        ...
                        <?php foreach ($owners as $owner) { ?>
                            <option value="<?= $owner->id ?>" <?php echo Input::get('owner_id') == $owner->id ? "selected" : "" ?>><?= $owner->contact_name; ?></option>
                        <?php } ?>
                    </select>
                    <br>
                </div>
...
<div class="box box-info tbl-box">
    <div align="left" id="paglink"><?php echo $walks->appends(array('start_date' => Session::get('start_date'), 'end_date' => Session::get('end_date'), 'walker_id' => Session::get('walker_id'), 'owner_id' => Session::get('owner_id'), 'status' => Session::get('status'), 'submit' => Session::get('submit')))->links(); ?></div>
                    ...
                    <td>
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                                ...
                                <li role="presentation"><a role="menuitem" id="map" tabindex="-1" href="{{ URL::Route('AdminRequestMap', $walk->id) }}">View Map</a></li>
