    ...
    <table class="table table-bordered">
        <tbody>
            ...
            <?php foreach ($owners as $owner) { ?>
                <tr>
                    <td><?= $owner->id ?></td>
                    <td><?php echo $owner->contact_name; ?> </td>
                    <td><?= $owner->email ?></td>
                    <td><?= $owner->phone ?></td>
                    <td>
                        <?php
                    ...
                    <td>
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                                ...
                                <?php
                                $check = RideRequest::where('owner_id', '=', $owner->id)->where('is_cancelled', '<>', '1')->where('is_completed', '<>', '1')->get()->count(); //print_r($check);
                                echo "<!-- check= " . $check ." -->";
                                if ($check == 0) {
                                    ?>
