@extends('learningcenter.providerLayout')
...
<div class="row mt">
    ...
    <div class="row mt">
        ...
        <form class="form-horizontal style-form" method="post" action="{{ URL::Route('updateProviderProfile') }}" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" style="height:30px;" class="form-control"  name="contact_name" value="{{ $user->contact_name }}">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" style="height:30px;" disabled="disabled" class="form-control" name="email"  value="{{ $user->email }}">
                </div>
            </div>
            <div class="form-group">
                <span id="no_mobile_error1" style="display: none"> </span>
                ...
                <div class="col-sm-10">
                    <input type="text" style="height:30px;"  class="form-control" name="phone"  value="{{ $user->phone }}"onkeypress="return Ismobile(event, 1);">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2" style="position:relative;top:15px;">
                    <input style="border:none;height:35px;line-height:22px;" type="file" class="form-control" name="picture" >
                </div>
            </div>
            <div class="form-group">
                <label style="text-align:center;" class="col-sm-2 col-sm-2 control-label">Bio</label>
                <div class="col-sm-10">
                    <input type="text" style="height:30px;"  class="form-control" name="bio"  value="{{ $user->bio }}">
                </div>
            </div>
            <div class="form-group">
                <label style="text-align:center;" class="col-sm-2 col-sm-2 control-label">Car Number</label>
                <div class="col-sm-10">
                    <input type="text" style="height:30px;"  class="form-control" name="car_number"  value="{{ $user->car_number }}">
                </div>
            </div>
            <div class="form-group">
                <label style="text-align:center;" class="col-sm-2 col-sm-2 control-label">Car Model</label>
                <div class="col-sm-10">
                    <input type="text" style="height:30px;"  class="form-control" name="car_model"  value="{{ $user->car_model }}">
                </div>
            </div>
            <div class="form-group">
                <label style="text-align:center;" class="col-sm-2 col-sm-2 control-label">Address</label>
                <div class="col-sm-10">
                    <input type="text" style="height:30px;"  class="form-control" name="address"  value="{{ $user->address }}">
                </div>
            </div>
            <div class="form-group">
                <label style="text-align:center;" class="col-sm-2 col-sm-2 control-label">State</label>
                <div class="col-sm-6">
                    <input type="text" style="height:30px;"  class="form-control" name="state"  value="{{ $user->state }}">
                </div>
            </div>
            <div class="form-group">
                <label style="text-align:center;" class="col-sm-2 col-sm-2 control-label">Country</label>
                <div class="col-sm-10">
                    <input type="text" style="height:30px;"  class="form-control" name="country"  value="{{ $user->country }}">
                </div>
            </div>
            <div class="form-group">
                <label style="text-align:center;" class="col-sm-2 col-sm-2 control-label">Zipcode</label>
                <div class="col-sm-10">
                    <input type="text" style="height:30px;" class="form-control" name="zipcode"  value="{{ $user->zipcode }}">
                </div>
            </div>
            <div class="form-group">
                <label style="text-align:center;" class="col-sm-2 col-sm-2 control-label">Time-Zone</label>
                <div class="col-sm-10">
                    <select class="form-control" id="timezone" name="timezone">
                        ...
                        <option value="Asia/Chennai" <?php
                        if ($user->timezone == 'Asia/Chennai') {
                            echo "selected";
                        }
                        ...
                        <option value="Asia/Mumbai" <?php
                        if ($user->timezone == 'Asia/Mumbai') {
                            echo "selected";
                        }
                        ?>>(UTC+05:30) New Delhi</option>
                        <option value="Asia/New Delhi" <?php
                        if ($user->timezone == 'Asia/New Delhi') {
                            echo "selected";
                        }
            ...
            <div class="form-group">
                <label style="text-align:center;" class="col-sm-2 col-sm-2 control-label">Service Type</label>
                <div class="col-sm-10">
                    <select style="height:30px;"  class="form-control"  name="services" id="services">
                        <?php foreach ($type as $service){?>
                        <option value="<?php echo $service->id ?>" <?php if($user->type==$service->id) { ?> selected ="selected" <?php } ?>><?php echo $service->name ?></option>
                        <?php } ?>
                    </select>
                </div>
            </div>
    ...
    <div class="form-panel" style="margin-top:2em;">
    <div class="row mt">
        <div class="col-lg-12">
        ...
        <form class="form-horizontal style-form" method="post" action="{{ URL::Route('updateProviderPassword') }}">
            ...
            <span style="text-align:center;" class="col-sm-2"></span>
