...
<div id="charge_ride_pop_up_responsive" class="modal fade" style="height:450px;" tabindex="-1" aria-hidden="false">
	<form role="form" class="form-horizontal" name="charge_form" id="charge_form">
		...
		<div class="text-center margin-bottom-20" style="margin-right: 70px;">
			...
			<input type="hidden" id="chargerequest_id" name="chargerequest_id" value="">
										...
										<div class="portlet-body form">
											<div class="form-body">
												...
												<div class="form-group form-md-line-input field-complete_form-details"><label class="col-md-4 control-label" for="form_control_1">Dropoff Address</label>
													<div class="col-md-6">
														<input class="new_input_text_field" type="text" name="dropoffaddress" id="dropoff" value="" />
														<span class="end"></span>
												...
												<div class="form-group form-md-line-input field-complete_form-distance"><label class="col-md-4 control-label" for="form_control_1">Distance (in miles)</label>
													<div class="col-md-6">
														 <input class="new_input_text_field" type="text" name="distance" id="distance" value="" >
														<div class="form-control-focus"></div>
													</div>
												</div>
												<div class="form-group form-md-line-input field-complete_form-time"><label class="col-md-4 control-label" for="form_control_1">Time (in mins)</label>
													...
													<div class="col-md-6">
														<input class="new_input_text_field" type="text" name="time" id="time" value="" >
														<div class="form-control-focus"></div>
												...
												<div class="form-group form-md-line-input field-complete_form-comment"><label class="col-md-4 control-label" for="form_control_1">Comment</label>
													<div class="col-md-6">
														<textarea style="margin: 0px;width:250px;height: 68px;" class="form-control" data-provide="markdown" id="complete_comment" name="complete_comment"></textarea>
														<div class="form-control-focus"></div>
													</div>
												</div>
...
<div class="modal fade modal1" id="ride_info_pop_up_responsive" role="dialog">
	<div class="modal-dialog" style="margin-top:180px;">
		<div class="modal-content">
			<div class="modal-header new-modal">
				<button type="button" class="close" data-dismiss="modal">&times;</button>
				<h4 class="modal-title" style="color:#ffffff;">Send Ride Information</h4>
			</div>
			<div class="modal-body" style="height:auto;">
				<form class="form-horizontal">
					<fieldset>
        ...
        <tbody>
			...
			?>
                <tr>
                    ...
                    <?php  		if ($walk->is_cancelled == 0 && $walk->is_completed == 0 && $walk->is_walker_started == 0) { ?>
					...
					<?php 	}	if($walk->is_confirmed==1 && $walk->confirmed_walker != 0) {?>
                    ...
                    <?php 			}
                                ...
                                if($walk->is_paid==0 && $walk->is_completed==1 && $walk->payment_mode==0 && $walk->total!=0) {?>
        ...
        document.mainForm.onclick = function() {
            ...
            $.ajax({
                ...
                url:'<?php echo URL::Route('DispatcherRideCompleted') ?>',
           		 data:{request_id:document.getElementById('comrequest_id').value,dropoffaddress:document.getElementById('dropoff').value,
				dist:document.getElementById('distance').value,distancetime:document.getElementById('time').value,
				comment:document.getElementById('complete_comment').value,walker_rating:newrating,feedback_comment:$('#feedback').val()},
            	success: function(data) {
                	console.log(data);
...
function create_invoice(requestid,total_service_amount){
    ...
    $('#chargerequest_id').val(requestid);
...
function charge_user(){
	...
	if($('#final_amount').val() =='' || $('#comment').val()==''){
		...
		$.ajax({
			...
			data:{request_id:$('#chargerequest_id').val(),final_amount:$('#final_amount').val(),add_fee:$('#additional_fee').val(),promo_offer:$('#promotional_offer').val(),comments:$('#comment').val(),approval_text:approval},
			success: function(data) {
				console.log(data);
