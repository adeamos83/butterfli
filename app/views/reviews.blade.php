                ...
                <table class="table table-bordered">
                    <tbody>
                        ...
                        <?php foreach ($provider_reviews as $reviewp) { ?>
                            <tr>
                                <td><?php echo $reviewp->owner_contact_name; ?> </td>
                                <td><?php echo $reviewp->walker_contact_name; ?> </td>
                ...
                <table class="table table-bordered">
                    <tbody>
                        ...
                        <?php foreach ($user_reviews as $reviewu) { ?>
                            <tr>
                                <td><?php echo $reviewu->walker_contact_name; ?> </td>
                                <td><?php echo $reviewu->owner_contact_name; ?> </td>
