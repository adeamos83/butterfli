...
<?php
$walker = Walker::where('is_available', 1)->orWhere('is_active',1)->orWhere('is_approved',1)->get();
?>
    ...
    <form role="form" id='request-form'  enctype="multipart/form-data">
        ...
        <div class="box-body">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="owner_name" value="{{$owner->contact_name}}" placeholder="{{ trans('customize.User');}} Name" >
            ...
            <?php if ($settdestination == '1') { ?>
                ...
                <br>
                <select name="walker" class="form-control" id="flow4">
                            <option value=''>--Select Provider--</option>
                            <?php foreach ($walker as $walk) { ?>
                                <option value="<?= $walk->id ?>"><?= $walk->contact_name ?></option>
                            <?php } ?>
                        </select>
                        <br>
                <div class="form-group">
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDaKg4PG8MB0N-XfDnVU8mOXDKSmrSo-iI&v=3.exp&sensor=false&libraries=places"></script><style>
    #map-canvas {
        height: 300px;
        width: 500px;
        margin: 0px;
