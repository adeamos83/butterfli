...
<!-- map page js starts -->
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB6NA_AMOEp8CiAxEZPWf_PTyy4v6xKvdA&libraries=places"></script>
<script type="text/javascript">
            ...
            var customIcons = {
                ...
                driver_free: {
                    icon: '<?php echo asset_url(); ?>/image/butterfli_driver_available.png',
                    shadow: 'https://labs.google.com/ridefinder/images/mm_20_shadow.png'
                },
                driver_not_approved: {
                    icon: '<?php echo asset_url(); ?>/image/butterfli_driver_inactive.png',
                    shadow: 'https://labs.google.com/ridefinder/images/mm_20_shadow.png'
                },
                driver_on_trip: {
                    icon: '<?php echo asset_url(); ?>/image/butterfli_driver_ontrip.png',
                    shadow: 'https://labs.google.com/ridefinder/images/mm_20_shadow.png'
                },
                driver: {
...
?>
	...
	<?php 					} ?>
            ...
            function Legend(controlDiv, map) {
                ...
                // Add the text
                controlText.innerHTML = '<p><b>Legend</b></p>' +
                        '<img src="<?php echo asset_url(); ?>/image/butterfli_driver_available.png" style="height:25px;"/> Available<br />' +
                        '<img src="<?php echo asset_url(); ?>/image/butterfli_driver_ontrip.png" style="height:25px;"/> On a <?= Config::get('app.generic_keywords.Trip') ?>';
                controlUI.appendChild(controlText);
            }

            google.maps.event.addDomListener(window, 'load', load('34.0522342', '-118.2436849')); //default location of los Angeles
