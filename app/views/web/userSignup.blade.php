            ...
            <div class="container">
                ...
                <form class="form-login" action="{{route('/user/save')}}" method="post">
                    ...
                    <div class="login-wrap">
                        <input type="text" name="contact_name" required class="form-control" placeholder="Name" autofocus><br>
                        <span id="no_mobile_error1" style="display: none"> </span>
                        <input type="text" name="phone" class="form-control" placeholder="Mobile Number" onkeypress="return Ismobile(event, 1);"><br>
...
<!--<input type="text" name="email" required class="form-control" placeholder="Email Address" >-->
                        ...
                        <input type="text" name="email" class="form-control" placeholder="Email Address" onblur="ValidateEmail(1)" id="email_check1" required="" >
                        ...
                        <button id="register" class="btn btn-theme btn-block" type="submit"><i class="fa fa-lock"></i> Register</button>
