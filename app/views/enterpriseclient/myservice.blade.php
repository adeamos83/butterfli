...
@section('content')
	...
	<!--<div class="row">
		<div class="table table-bordered" style="text-align: center;border: 2px solid #dddddd;width:20%;margin-left:450px;">Total Amount: $<?php echo $enterprise_client->total_amount ?>
			<br>Current Balance: $<?php echo $enterprise_client->account_balance ?>
		</div>
	</div>-->
	...
	<div><a id="feedback_ride_pop_up" class="btn-sm" data-toggle="modal" href="#feedback_ride_pop_up_responsive" style="display:none;"></a></div>

	<div class="modal fade modal1" id="feedback_ride_pop_up_responsive" role="dialog">
		<div class="modal-dialog" style="margin-top:180px;">
			<div class="modal-content">
				<div class="modal-header new-modal">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<h4 class="modal-title" style="color:#ffffff;">Feedback</h4>
				</div>
											...
											<div class="portlet-body form">
												<div class="form-body">
													...
													<div class="form-group form-md-line-input field-complete_form-comment">
														<label class="col-md-4 control-label" for="form_control_1">Rating</label>
														<div class="col-md-6">
															<div class="cont">
																<div class="stars">
	...
	<div class="box box-info tbl-box">
		...
		<div class="row white_bg">
			<table class="table table-bordered">
				...
				<tr>
					<th>Request ID</th>
                    <?php if(Session::get('user_select') != 3){ ?>
								<th>Agent Name</th>
                    <?php } ?>

					<th>{{ trans('customize.User')}} Name</th>
					<th>{{ trans('customize.User')}} Phone</th>
					<th>{{ trans('customize.Provider')}}</th>
					<th>{{ trans('customize.Provider')}} Phone</th>
					<th>Pickup address</th>
					<th>Dropoff address</th>
					<th>Service</th>
					<th>ETA driver (in mins)</th>
					<th>Date/Time</th>
					<th>Status</th>
					<th>Payment Mode</th>
				...
				<tr>
					...
					<td><?php echo $walk->estimated_time;?></td>
					...
					<td>
                        <?php if($walk->payment_mode==3){ echo $walk->provider_name;} elseif($walk->payment_mode==0){ echo "Credit Card"; } ?>
					</td>
					<td>
                        <?php
                        if ($walk->is_paid == 1) {
                    ...
                    <?php 	if(Session::get('user_select') != 3){ ?>
								<td>
									<div class="dropdown">
										<button class="btn btn-flat btn-info dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown" style="width:90px;">
											Actions
										...
										<?php
											  ...
											  if($walk->is_paid==0 && $walk->is_cancelled==0 && $walk->is_confirmed==1 && $walk->is_completed == 0) {?>
												<li role="presentation"><a role="menuitem" id="ride_completed" tabindex="-1" href="javascript:void(0)" onclick="complete_ride('<?php echo $walk->id ?>');">Ride Complete</a></li>
										<?php }
	...
	<script type="text/javascript">
        ...
        function insert_cancel_reason(){
            ...
            if(document.getElementById('details').value==''){
                ...
                $.ajax({
                    type: "POST",
                    url:'<?php echo URL::Route('cancelridehealthcare') ?>',
        ...
        function complete_ride(requestid){
            ...
            $( "#feedback_ride_pop_up" ).trigger( "click" );
        }
        ...
        function walker_ride_complete(){
            ...
            document.mainForm.onclick = function() {
                ...
                $.ajax({
                    type: "POST",
                    url: '<?php echo URL::Route('HealthcareRideCompleted') ?>',
                    ...
                    data: {
                        request_id: document.getElementById('comrequest_id').value,
                        walker_rating: newrating,
                        feedback_comment: $('#feedback').val()
                    },
                    success: function (data) {
                        console.log(data);
                        $('#feedback_ride_pop_up_responsive').modal('hide');
                        location.reload();
                    }
                });
            }
        ...
        function send_ride_info(){
            if($('#sms').val() == '' && $('#email').val() ==''){
                ...
                $.ajax({
                    type: "POST",
                    url:'<?php echo URL::Route('SendRideInfo') ?>',
