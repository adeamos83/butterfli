    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav">
            ...
            <li id="walks" title="Request">
                <a href="{{ URL::Route('AdminRequest') }}"><img src="<?php echo asset_url() ?>/image/menu_buttons/all_jobs.png"/><br>Request</a>
            </li>
...
<!-- 
    ...
    <div class="container">
        <ul class="nav nav-pills">
            ...
            <li id="walks" title="Request">
                <a href="<?php echo web_url(); ?>/admin/requests"><img src="<?php echo asset_url() ?>/image/menu_buttons/all_jobs.png"/>Request</a>
            </li>
            <li id="owners" title="Users">
