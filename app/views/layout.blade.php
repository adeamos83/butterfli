    ...
    <body class="skin-blue" >
        ...
        <header class="header">
            <a class="logo" href="{{ URL::Route('AdminMapview') }}" >
                ...
                <img src="<?php echo asset_url(); ?>/web/img/butterfli_logo_white.png" style="height:20px;"> 
            </a>
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="left-side sidebar-offcanvas">
                ...
                <section class="sidebar">
                    <ul class="sidebar-menu">
                        ...
                        <li id="learning" title="Driver Learning Center">
                            <a href="{{ URL::Route('DriverLearningCenter') }}"><i class="fa fa-location-arrow"></i> <span>Driver Learning Center</span></a>
                        </li>
                        <li id="dispatchers" title="Dispatchers" >
                            <a href="{{ URL::Route('GetDispatchers') }}"><i class="fa fa-users"></i> <span>Dispatchers</span></a>
                        </li>
                        <li id="transportationproviders" title="transportationproviders" >
                            <a href="{{ URL::Route('AdminTransportationProvider') }}"><i class="fa fa-users"></i> <span>Transportation Providers</span></a>
                        </li>
                        <li id="healthproviders" title="healthproviders" >
                            <a href="{{ URL::Route('EnterpriseClients') }}"><i class="fa fa-users"></i> <span>Enterprise Clients</span></a>
                        </li>
                        <li id="healthcareagents" title="healthcareagents" >
                            <a href="{{ URL::Route('AdminHealthcareAgents') }}"><i class="fa fa-users"></i> <span>Healthcare Agents</span></a>
                        </li>
                        <li id="module" title="Training Module">
                            <a href="{{ URL::Route('TrainingModuleAdmin') }}"><i class="fa fa-file-text-o"></i> <span>Training Modules</span></a>
                        </li>

                        <li id="walks" title="Request">
                            <a href="{{ URL::Route('AdminRequest') }}"><i class="fa fa-location-arrow"></i> <span>{{ trans('customize.Request').'s'; }}</span></a>
                        </li>
                        <!--li id="healthcare" title="Healthcare Request">
                            <a href="{{ URL::Route('AdminHealthcareRequest') }}"><i class="fa fa-location-arrow"></i> <span>Healthcare Request</span></a>
                        </li>
                        <li id="dispatcherwalks" title="Disptacher Request">
                            <a href="{{ URL::Route('AdminDispatcherRequest') }}"><i class="fa fa-location-arrow"></i> <span>Dispatcher Request</span></a-->
                        <!--/li-->
                        <li id="feecalc" title="Fee Calculator">
                            <a href="{{ URL::Route('FeeCalculator') }}"><i class="fa fa-cogs"></i> <span>Fee Calculator</span></a>
                        </li>
                        ...
                        <li id="week_statement" title="Weekly Payment.">
                            <a href="{{ URL::Route('AdminRequest_payment') }}"><i class="fa fa-bar-chart-o"></i> <span>{{trans('customize.WeekStatement');}}</span></a>
                        </li>
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1 id="page_title"><?php  //$siteTitle = Config::get('app.website_title');echo $siteTitle;?>
					<?= $title ?>
					</h1>
				</section>
