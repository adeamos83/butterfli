...
<html>
    <head>
        ...
        <title>Invitation for new event</title>
    ...
    <body style="background-color:#ecf0f1">
        <div align="center" style="background-color:#ecf0f1;">
            ...
            <!--<table id="email-penrose-conteneur" width="540" align="center" style="padding:20px 0px;" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td>
                        <table width="540" class="resp-full-table" align="center" border="0" cellspacing="0" cellpadding="0">
                            <tr>
...
<table id="email-penrose-conteneur" width="540" align="center" style="border-right:1px solid #e2e8ea; border-bottom:1px solid #e2e8ea; border-left:1px solid #e2e8ea; background-color:#ffffff;" border="0" cellspacing="0" cellpadding="0">
            ...
            <table width="540" class="resp-full-table" align="center" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="resp-full-td" valign="top" style="padding:20px; text-align:center;">
                        <span style="font-size:25px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#ffffff"><a href="{{ web_url() }}" style="color:#ffffff; outline:none; text-decoration:none;">Invitation for {{ $event_name }}</a></span>
                    </td>
                </tr>
                <!-- <tr>
    ...
    <tr>
        <td style="border-bottom: 1px solid #e2e8ea">
            <table width="540" class="resp-full-table" align="center" border="0" cellspacing="0" cellpadding="0" style="padding:20px;">
                <tr>
                    <td width="100%">
                            ...
                            <tr>
                                <td width="100%" class="resp-full-td" valign="top" style="text-align : justify;">
                                    ...
                                    <div style="padding: 10px;font-size:12px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#545454;text-align:left;">
                                        ...
                                        and the time of it will be on 
                                        <strong style="font-weight: bold;">
                                            <?php echo date("g:ia l jS F Y", strtotime($event_time)); ?>
                                        </strong>.
                                        you can get benefit of 
                                        <strong style="font-weight: bold; color:#DB3636;">
                                            {{Config::get('app.generic_keywords.Currency')}} {{ $event_bonus }}
                                        </strong> 
                                        to reach to
                                        <strong style="font-weight: bold;">
                                            {{ $event_name }}
                                    ...
                                    <!--<br><br>
                                    <div style="text-align:center"><a href="#" style="padding: 10px;font-size:18px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100;background-color: #ff9d3d;color:#fff;text-align:center;  text-decoration: none;">Follow</a></div>-->
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td width="100%" class="resp-full-td" valign="top" style="text-align : justify;">
                        ...
                        <br>
                        <br>
                        <div style="font-size:12px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#545454;text-align:center;">
                            For more details contact to event owner : 
                            <strong style="font-weight: bold;">
                                {{ $event_admin_email }}
                            </strong>
                        </div>
                ...
                <tr>
                    <td width="100%" class="resp-full-td" valign="top" style="text-align : justify;">
                        ...
                        <div style="font-size:10px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#545454;text-align:center;">
                            This beneficial code will be usable before and after three hours of start time of {{ $event_name }}.
                        </div>
                        <!--<div style="text-align:center"><a href="#" style="padding: 10px;font-size:18px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100;background-color: #ff9d3d;color:#fff;text-align:center;  text-decoration: none;">Login</a></div>
