...
<link href="{{asset('css/bootstrap-datetimepicker.min.css')}}" rel="stylesheet">
  ...
  <div class="box box-primary">
                  ...
                  <form method="post" action="{{ URL::Route('AdminProviderBanking') }}" id="addressformadmin"  enctype="multipart/form-data">
              <div class="form-group" style="margin-left:10px;margin-right:10px;">
              <input type="hidden" name="id" value="<?= $provider->id ?>">
              <input type="text" name="contact_name" class="form-control" placeholder="Name" value="{{ $provider -> contact_name }}" required><br>
