...
function notzero(i)
{
    var mailvalue = document.getElementById('no_zero_' + i);
    if (mailvalue.value > 0 || mailvalue.value == "")
    {
        var eml_err = document.getElementById("no_zero_error" + i);
        eml_err.style.color = error_color;
        eml_err.innerHTML = "";
        eml_err.style.display = "none";
        return true;
        ...
        var eml_err = document.getElementById("no_zero_error" + i);
        eml_err.style.color = error_color;
        eml_err.innerHTML = "You can't set this field as 0 (Zero).<br/>";
        eml_err.style.display = "inline";
        /*var mailvalue2 = document.getElementById('email_check'+i);*/
        setTimeout(function () {
            document.getElementById('no_zero_' + i).focus();
        }, 100);
        return false;
    }
}
